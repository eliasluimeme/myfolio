  ...
  return (
    <div className="relative w-full min-h-screen">
      <div className="absolute inset-0 flex items-center justify-center">
        <Image
          src="/bg.webp"  // Replace with your image path
          layout="fill"
          objectFit="cover"
          quality={100}
          alt="Background"
      ...
      <section
        ref={sectionRef}
        id={MENULINKS[0].ref}
        className="w-full z-10 flex md:items-center py-8 2xl:container mx-auto xl:px-20 md:px-12 px-4 min-h-screen relative mb-24"
        style={{ opacity: 0 }}
      >
        <style global jsx>
          {`
        ...
        <div className="flex flex-col pt-40 md:pt-0 select-none">
          ...
          <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
            <span className={`relative ${styles.emphasize} staggered-reveal`}>Elias</span>
            <span className="staggered-reveal"> Akry</span>
          </h1>
          <h5
            className={`${styles.intro} font-mono font-medium text-indigo-light staggered-reveal mb-5`}
          >
        ...
        <div
          className="absolute invisible w-1/4 bottom-1.5 lg:visible lg:right-12 2xl:right-16"
          ref={lottieRef}
        />
      </section>
    </div>
