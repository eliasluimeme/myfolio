                ...
                <div className="flex flex-col">
                  ...
                  <h2 className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
                    ...
                    <div className="flex flex-col pt-20 staggered-reveal">
                        ...
                        <pre data-prefix="$" className="px-2 py-1 text-sm text-gray-light-4"><code>npm graduat from <a href="https://1337.ma/en/" target="_blank" rel="noopener noreferrer" className="hover:text-white">1337</a> (<a href="https://42.fr/en/homepage/" target="_blank" rel="noopener noreferrer" className="hover:text-white">42 Network</a>) - <a href="https://um6p.ma/" target="_blank" rel="noopener noreferrer" className="hover:text-white">UM6P</a></code></pre>
                        ...
                        <pre data-prefix="$" className="px-2 py-1 text-sm text-gray-light-4"><code>npm start hustling</code></pre>
